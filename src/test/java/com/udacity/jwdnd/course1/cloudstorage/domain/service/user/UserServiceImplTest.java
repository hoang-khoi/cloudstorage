...
class UserServiceImplTest {
    ...
    void testCreateUser_BlankFirstName_UserExceptionThrown() {
        Exception ex = assertThrows(UserException.class, () -> userService.createUser(" ", "Hoang", "hotel_kilo", "pwd"));
        assertEquals("Invalid user input.", ex.getMessage());
    }

    @Test
    void testCreateUser_BlankLastName_UserExceptionThrown() {
        Exception ex = assertThrows(UserException.class, () -> userService.createUser("Khoi", "  ", "hotel_kilo", "pwd"));
        assertEquals("Invalid user input.", ex.getMessage());
    }

    @Test
    void testCreateUser_BlankUserName_UserExceptionThrown() {
        Exception ex = assertThrows(UserException.class, () -> userService.createUser("Khoi", "Hoang", "  ", "pwd"));
        assertEquals("Invalid user input.", ex.getMessage());
    }

    @Test
    void testCreateUser_WeakPassword_UserExceptionThrown() {
        Exception ex = assertThrows(UserException.class, () -> userService.createUser("Khoi", "Hoang", "hoang_khoi", "1234567"));
    ...
    void testCreateUser_UsernameAlreadyExisted_UserExceptionThrown() {
        ...
        Exception ex = assertThrows(UserException.class, () -> userService.createUser("khoi", "hoang", "existed", "12345678"));
    ...
    void testCreateUser_Success() throws UserException {
        ...
        userService.createUser("khoi", "hoang", "khoi_hoang", "12345678");
